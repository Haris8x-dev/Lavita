...
const Home = () => {
  ...
  const nextSlide = () => {
    ...
    setCarouselState({ activeIndex: nextIndex })
  }

  const prevSlide = () => {
    const totalSlides = experiences.length
    const prevIndex = (carouselState.activeIndex - 1 + totalSlides) % totalSlides
    setCarouselState({ activeIndex: prevIndex })
  }

  const goToSlide = (index: number) => {
    setCarouselState({ activeIndex: index })
  }
  ...
  const carouselCardVariants: Variants = {
    left: { x: -160, scale: 0.75, opacity: 0.5, zIndex: 10 },
    center: { x: 0, scale: 1, opacity: 1, zIndex: 30 },
    right: { x: 160, scale: 0.75, opacity: 0.5, zIndex: 10 }
  }
    ...
    return (
      ...
      >
        ...
        <div className={`relative flex flex-col lg:flex-row items-center gap-12 ${
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-emerald-400/20 bg-linear-to-br from-slate-800/50 to-slate-900/50">
              <Image
                src={service.image}
                alt={service.title}
                loading="lazy"
  ...
  const ExperienceCard = ({ 
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-800/95 to-slate-900/98 border-2 border-emerald-400/50 shadow-2xl shadow-emerald-500/30"
        whileHover={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          ...
          <div className="min-h-screen flex flex-col justify-center py-20">
            ...
            <div className="relative h-[600px] lg:h-[700px] flex items-center justify-center">
              <motion.button
                onClick={prevSlide}
                className="absolute left-4 lg:left-8 z-50 w-14 h-14 bg-black/60 border border-emerald-400/40 rounded-full flex items-center justify-center text-emerald-300 hover:bg-emerald-400/25 hover:border-emerald-400/60 hover:text-white transition-all duration-300 group shadow-2xl shadow-black/60"
              ...
              <motion.button
                onClick={nextSlide}
                className="absolute right-4 lg:right-8 z-50 w-14 h-14 bg-black/60 border border-emerald-400/40 rounded-full flex items-center justify-center text-emerald-300 hover:bg-emerald-400/25 hover:border-emerald-400/60 hover:text-white transition-all duration-300 group shadow-2xl shadow-black/60"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
              >
               <ChevronRight />
          ...
          {/* ABOUT SECTION */}
          <div className="min-h-screen pt-32 flex items-center" id="about">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-6 -left-6 bg-linear-to-br from-slate-800/90 to-slate-900/95 rounded-2xl p-6 border-2 border-emerald-400/30 shadow-2xl"
                >
