  ...
  const footerData: FooterSection[] = [
    {
      ...
      links: [
        ...
        { id: '1-5', label: 'Gallery', href: '/gallery' },
      ],
    },
    {
      id: '2',
      title: 'Services',
      links: [
        { id: '2-1', label: 'Luxury Suites', href: '/services/luxury-suites' },
        { id: '2-2', label: 'Adventure Tours', href: '/services/adventure-tours' },
        { id: '2-3', label: 'Spa & Wellness', href: '/services/spa-wellness' },
        { id: '2-4', label: 'Fine Dining', href: '/services/fine-dining' },
        { id: '2-5', label: 'Event Planning', href: '/services/event-planning' },
      ],
    },
    {
      id: '3',
      title: 'Facilities',
      links: [
        { id: '3-1', label: 'Kids Activity Zone', href: '/facilities/kids-zone' },
        { id: '3-2', label: 'Conference Halls', href: '/facilities/conference-halls' },
        { id: '3-3', label: 'Seasonal Activities', href: '/facilities/seasonal-activities' },
        { id: '3-4', label: 'Outdoor Adventures', href: '/facilities/outdoor-adventures' },
        { id: '3-5', label: 'Wildlife Tours', href: '/facilities/wildlife-tours' },
      ],
    },
    {
      id: '4',
