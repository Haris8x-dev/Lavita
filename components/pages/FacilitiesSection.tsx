      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-full h-px bg-gradient-to-r from-transparent via-emerald-400/50 to-transparent mb-8"
          />
  ...
  return (
    ...
    >
      ...
      <div className={`flex-1 ${isEven ? 'lg:pr-8' : 'lg:pl-8'}`}>
        ...
        >
          <div className="w-8 h-0.5 bg-gradient-to-r from-transparent to-emerald-400" />
          <span className="text-emerald-400 font-light tracking-widest text-sm uppercase">
            {facility.title}
          </span>
          <div className="w-8 h-0.5 bg-gradient-to-l from-transparent to-emerald-400" />
        </motion.div>
        ...
        <Link href={facility.link}>
          <motion.button
            ...
            viewport={{ once: true }}
            className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-green-500 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-emerald-500/30 transition-all duration-300 border border-emerald-400/30 inline-block"
          >
            {facility.buttonText}
          </motion.button>
        </Link>
